        ...
        <Box className="registration-steps-container">
            <Box className="steps-sidebar">
                <Box className="step-section">
                    ...
                    <Paper
                        elevation={1}
                        className={`step-card ${activeStep === 'restaurant' ? 'active' : ''}`}
                    ...
                    <Paper
                        elevation={1}
                        className={`step-card ${activeStep === 'typeTimings' ? 'active' : ''}`}
                    ...
                    <Paper
                        elevation={1}
                        className={`step-card ${activeStep === 'uploadImages' ? 'active' : ''}`}
                ...
                <Box className="step-section">
                    ...
                    <Paper
                        elevation={1}
                        className={`step-card ${activeStep === 'restaurantInfo' ? 'active' : ''}`}
                    ...
                    <Paper
                        elevation={1}
                        className={`step-card ${activeStep === 'uploadDocs' ? 'active' : ''}`}
